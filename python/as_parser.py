...
if not options.autonomousSystems:
	print 'specify --as=List of autonomous systems (one or more separated by comma without whitespaces or use \'\'). Example:'
	print 'python ' + sys.argv[0] + ' --as=AS28890 or python ' + sys.argv[0] + ' --as=AS28890,AS12668'
	sys.exit()
...
output = output.strip()
if not output:
	print 'whois return empty answer'
	sys.exit()
